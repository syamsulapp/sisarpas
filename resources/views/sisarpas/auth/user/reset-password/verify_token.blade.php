        ...
        <div class="row border rounded-5 p-3 bg-white shadow box-area">
            ...
            <div class="col-md-6 right-box">
                <div class="row align-items-center">
                    ...
                    @endif
                    <form action="{{ route('user.check_verify_token') }}" method="POST">
                        @csrf
                        <div class="input-group mb-3">
                            <div class="otp-field mb-4">
                                <input name="token1" type="text" />
                                <input name="token2" type="text" disabled />
                                <input name="token3" type="text" disabled />
                                <input name="token4" type="text" disabled />
                                <input name="token5" type="text" disabled />
                                <input name="token6" type="text" disabled />
                            </div>
                        </div>
